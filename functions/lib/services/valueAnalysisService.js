...
exports.ValueAnalysisService = void 0;
...
class ValueAnalysisService {
     ...
     * 가치관 평가 시작
     */
    async startValueAssessment(groupId, userId, assessmentVersion = '2.0') {
        try {
            ...
            // 평가 저장
            await this.database.collection('value_assessments').doc(assessmentId).set(Object.assign(Object.assign({}, assessment), { createdAt: (0, firebaseAdmin_1.serverTimestamp)() }));
            return assessment;
        }
        catch (error) {
     ...
     * 가치관 평가 제출
     */
    async submitValueAssessment(assessmentId, values) {
        try {
     ...
     * 그룹 가치관 분석 실행
     */
    async analyzeGroupValues(groupId) {
        try {
            // 그룹의 모든 가치관 평가 조회
            ...
            // 분석 결과 저장
            await this.database.collection('value_analyses').doc(`${groupId}_${Date.now()}`).set(Object.assign(Object.assign({}, analysisResult), { createdAt: (0, firebaseAdmin_1.serverTimestamp)() }));
     ...
     * AI 기반 가치관 분석 생성
     */
    async generateValueAnalysis(assessments, groupId) {
        const prompt = `
...
`;
     ...
     * 그룹 평가 조회
     */
    async getGroupAssessments(groupId) {
        try {
            ...
            return snapshot.docs.map(doc => {
                var _a;
                return (Object.assign(Object.assign({}, doc.data()), { completedAt: ((_a = doc.data().completedAt) === null || _a === void 0 ? void 0 : _a.toDate()) || new Date() }));
            });
        }
        catch (error) {
     ...
     * 폴백 분석 결과
     */
    getFallbackAnalysis(assessments, groupId) {
        return {
            groupId,
            analysisDate: new Date(),
...
exports.ValueAnalysisService = ValueAnalysisService;
//# sourceMappingURL=valueAnalysisService.js.map