...
exports.AIWarningService = void 0;
class AIWarningService {
    /**
     * 컨텍스트별 AI 경고 생성
     */
    static generateContextualWarning(context, additionalInfo) {
        ...
        return Object.assign(Object.assign({}, baseWarning), { limitations: contextualLimitations, recommendations, timestamp: new Date().toISOString(), version: "2.0" });
    }
    /**
     * 기본 경고 메시지 생성
     */
    static getBaseWarning(context) {
        const warnings = {
            personal_profiling: {
     ...
     * 컨텍스트별 한계점 설명
     */
    static getContextualLimitations(context, additionalInfo) {
        ...
        // 추가 정보에 따른 한계점 보완
        if ((additionalInfo === null || additionalInfo === void 0 ? void 0 : additionalInfo.dataPoints) && additionalInfo.dataPoints < 10) {
            limitations.push("분석에 사용된 데이터가 제한적이어서 정확도가 낮을 수 있습니다.");
        }
        if ((additionalInfo === null || additionalInfo === void 0 ? void 0 : additionalInfo.analysisDepth) === 'basic') {
     ...
     * 컨텍스트별 권장사항 제공
     */
    static getContextualRecommendations(context) {
...
exports.AIWarningService = AIWarningService;
//# sourceMappingURL=aiWarningService.js.map